...
class LearningAgent(Agent):
    ...
    # XXX: higher alpha worked better
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing == True:
            ...
            if SimOptimized:
                ...
                #self.epsilon *= 1/(self.trial_number*self.trial_number)
        ...
        if not self.learning:
            ...
            if rval < self.epsilon:
                ...
                for k,v in act.iteritems():
                    if v == high_q:
                        hv_actions.append(k)
                action = random.choice(hv_actions)
        light = inputs['light']
        if action == None:
            if light == 'green' and inputs['oncoming'] != 'left': # No oncoming traffic
                violation = 1
                print "violation: light: ", light, "oncoming: ", inputs['oncoming']
        return action
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
            ...
            if action in act:
                ...
                action_val = action_val + self.alpha*(reward-action_val)
                self.Q[state][action] = action_val   
        return
